...
/**
 * Behavior for current helper file of Go To Action.
 *
 * - helper<br/>
 * - test case
 *
...
public class CakePhpHelperGoToStatus extends CakePhpGoToStatus {
    ...
    public static CakePhpHelperGoToStatus getInstance() {
        return INSTANCE;
    }
    ...
    protected void scan(PhpModule phpModule, FileObject currentFile, int offset) {
        ...
        // scan
        final CakePhpHelperVisitor visitor = new CakePhpHelperVisitor(currentFile);
        try {
            scanHelper(visitor, currentFile);
    ...
    private void scanHelper(final DefaultVisitor visitor, FileObject currentFile) throws ParseException {
