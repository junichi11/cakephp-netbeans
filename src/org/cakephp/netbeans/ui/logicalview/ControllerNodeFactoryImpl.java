...
public class ControllerNodeFactoryImpl implements NodeFactory {
    ...
    public NodeList createNodes(Project prj) {
        ...
        FileObject targetDir = CakePhpFrameworkProvider.getCakePhpDirectory(module).getFileObject("app/controllers"); // NOI18N
        if (targetDir == null) {
            targetDir = CakePhpFrameworkProvider.getCakePhpDirectory(module).getFileObject("app/Controller"); // NOI18N
        }
        if (targetDir != null) {
            try {
