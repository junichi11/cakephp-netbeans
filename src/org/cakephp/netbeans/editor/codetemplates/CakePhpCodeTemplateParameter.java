 ...
 * @author junichi11
 */
abstract class CakePhpCodeTemplateParameter {

    private final CodeTemplateParameter parameter;

    public CakePhpCodeTemplateParameter(CodeTemplateParameter parameter) {
     ...
     *
     * @param request {@link CodeTemplateInsertRequest}
     * @param fileObject current file
     * @param cakeModule {@link CakePhpModule}
     */
    ...
    public static class CakePhpCodeTemplateParameterFactory {
        ...
        private static final String CAKE_FILE_NAME_VALUE = "CakeFileName"; // NOI18N
        private static final String CAKE_APP_USES_VALUE = "CakeAppUses"; // NOI18N
