...
public abstract class Method {
    ...
    public static final List<String> METHODS = Arrays.asList("element"); // NOI18N
    ...
    protected String setSubDirectoryPath(String filter) {
        ...
        if (lastSlash > 0) {
            subDirectoryPath = SLASH + filter.substring(0, lastSlash);
    ...
    public abstract CompletionItem createCompletionItem(String element, int startOffset, int removeLength);
