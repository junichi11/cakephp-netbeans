...
public abstract class FieldImpl {
    ...
    private final Token<PHPTokenId> caretPositionToken;
    private final String caretPositionText;
    protected final PhpModule phpModule;

    public FieldImpl(String name, Document doc, int offset, PhpModule phpModule) {
        this.name = name;
        this.doc = doc;
        this.offset = offset;
    ...
    protected Token<PHPTokenId> getCaretPositionToken() {
        return caretPositionToken;
    }

    protected String getCaretPosigionText() {
        return caretPositionText;
    }

    protected abstract List<CompletionItem> getCompletionItems();
